...
urlpatterns = [
    ...
    path('catalogs/create/' , shareek.CreateCatalogView.as_view()),
    ...
    path('client-offers/create/' , shareek.CreateClientOffer.as_view()),
    ...
    path('service-offers/create/' , shareek.CreateServiceOffer.as_view()),
