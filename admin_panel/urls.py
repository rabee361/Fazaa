...
OrganizationPatterns=[
    ...
    path('catalogs/create/' , organization_views.CreateCatalogView.as_view() , name="create-catalog"),
    path('catalogs/<int:id>/update/' , organization_views.UpdateCatalogView.as_view() , name="update-catalog"),
    path('catalogs/<int:id>/delete/' , organization_views.DeleteCatalogView.as_view() , name="delete-catalog"),
    ...
    path('client-offers/create/' , organization_views.CreateClientOffer.as_view() , name="create-client-offer"),
    ...
    path('service-offers/create/' , organization_views.CreateServiceOffer.as_view() , name="create-service-offer"),
