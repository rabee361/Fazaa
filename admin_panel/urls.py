...
UsersPatterns=[
    path('users/clients/' , user_views.ListClients.as_view() , name="clients"),
    path('users/clients/create/' , user_views.CreateClient.as_view() , name="create-client"),
    path('users/clients/<int:id>/update/' , user_views.UpdateClient.as_view() , name="update-client"),
    path('users/clients/<int:id>/delete/' , user_views.DeleteClient.as_view() , name="delete-client"),
    path('users/clients/<int:id>/' , user_views.GetClient.as_view() , name="get-client"),

    path('users/shareek/' , user_views.ListShareeks.as_view() , name="shareeks"),
    path('users/shareek/create/' , user_views.CreateShareek.as_view() , name="create-shareek"),
    path('users/shareek/<int:id>/update/' , user_views.UpdateShareek.as_view() , name="update-shareek"),
    path('users/shareek/<int:id>/delete/' , user_views.DeleteShareek.as_view() , name="delete-shareek"),
    path('users/shareek/<int:id>/' , user_views.GetShareek.as_view() , name="get-shareek"),

    path('users/admins/' , user_views.ListAdmins.as_view() , name="admins"),
    path('users/admins/create/' , user_views.CreateAdmin.as_view() , name="create-admin"),
    path('users/admins/<int:id>/update/' , user_views.UpdateAdmin.as_view() , name="update-admin"),
    path('users/admins/<int:id>/delete/' , user_views.DeleteAdmin.as_view() , name="delete-admin"),
    path('users/admins/<int:id>/' , user_views.GetAdmin.as_view() , name="get-admin"),

    path('users/subscriptions/' , user_views.ListSubscriptions.as_view() , name="subscriptions"),
    path('users/subscriptions/create/' , user_views.CreateSubscription.as_view() , name="create-subscription"),
    path('users/subscriptions/<int:id>/update/' , user_views.UpdateSubscription.as_view() , name="update-subscription"),
    path('users/subscriptions/<int:id>/delete/' , user_views.DeleteSubscription.as_view() , name="delete-subscription"),
    path('users/subscriptions/<int:id>/' , user_views.GetSubscription.as_view() , name="get-subscription"),
]


OrganizationPatterns=[
    path('organization-types/' , organization_views.ListOrganizationType.as_view() , name="organization-types"),
    path('organization-types/create/' , organization_views.CreateOrganizationType.as_view() , name="create-organization-type"),
    path('organization-types/<int:id>/update/' , organization_views.UpdateOrganizationType.as_view() , name="update-organization-type"),
    path('organization-types/<int:id>/delete/' , organization_views.DeleteOrganizationType.as_view() ,name="delete-organization-type"),
    ...
    path('notifications/' , organization_views.NotificationsView.as_view() , name="notifications"),
...
urlpatterns = [
    ...
    include(UsersPatterns),
    include(OrganizationPatterns),
]
